...
public final class DestroyCPortalEvent extends Event implements Cancellable {
    ...
    public DestroyCPortalEvent(Player player, Location portalLocation, CPortal cportal) {
    	this.player=player;
